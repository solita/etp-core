...
(defn rivitalot-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[80 "A"] [110 "B"] [150 "C"] [210 "D"] [340 "E"] [410 "F"]]
   "G"))

(defn asuinkerrostalot-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[75 "A"] [100 "B"] [130 "C"] [160 "D"] [190 "E"] [240 "F"]]
   "G"))

(defn toimistorakennukset-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[80 "A"] [120 "B"] [170 "C"] [200 "D"] [240 "E"] [300 "F"]]
   "G"))

(defn liikerakennukset-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[90 "A"] [170 "B"] [240 "C"] [280 "D"] [340 "E"] [390 "F"]]
   "G"))

(defn majoitusliikerakennukset-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[90 "A"] [170 "B"] [240 "C"] [280 "D"] [340 "E"] [450 "F"]]
   "G"))

(defn opetusrakennukset-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[90 "A"] [130 "B"] [170 "C"] [230 "D"] [300 "E"] [360 "F"]]
   "G"))

(defn liikuntahallit-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
   [[90 "A"] [130 "B"] [170 "C"] [190 "D"] [240 "E"] [280 "F"]]
   "G"))

(defn sairaalat-2018 [e-luku _]
  (e-luokka-from-e-luku
   e-luku
