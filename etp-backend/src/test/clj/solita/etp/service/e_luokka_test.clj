...
(t/deftest e-luokka-from-limits-test
  (let [limits [[10 "A"] [20 "B"] [30 "C"] [40 "D"] [50 "E"] [60 "F"]]]
    ...
    (t/is (= "E" (service/e-luokka-from-limits limits 41)))
    (t/is (= "F" (service/e-luokka-from-limits limits 59)))
    (t/is (= "G" (service/e-luokka-from-limits limits 61)))))
...
(t/deftest find-e-luokka-info-test
  ...
  (t/is (= {:e-luokka "D"
            ...
            :limits [[80 "A"] [110 "B"] [150 "C"] [210 "D"] [340 "E"] [410 "F"]]}
  ...
  (t/is (= {:e-luokka "F"
            ...
            :limits  [[90 "A"] [170 "B"] [240 "C"] [280 "D"] [340 "E"] [390 "F"]]}
  ...
  (t/is (= {:e-luokka "D"
            ...
            :limits [[90 "A"] [130 "B"] [170 "C"] [230 "D"] [300 "E"] [360 "F"]]}
  ...
  (t/is (= {:e-luokka "G"
            ...
            :limits [[90 "A"] [130 "B"] [170 "C"] [190 "D"] [240 "E"] [280 "F"]]}
  ...
  (t/is (= {:e-luokka "E"
            :luokittelu {:id 9
                         :label-fi "Sairaalat"
                         :label-sv "Sjukhus"}
            :limits [[150 "A"] [350 "B"] [450 "C"] [550 "D"] [650 "E"] [800 "F"]]}
