...
create table energiatodistus (
 ...
 pt$kieli integer references kielisyys (id),
 pt$kiinteistotunnus text,
 pt$laatimisvaihe integer references laatimisvaihe (id),
...
call audit.activate('energiatodistus'::name);

create table audit.energiatodistus_tila (
...
call audit.create_audit_insert_trigger('energiatodistus_tila'::name, 'energiatodistus'::name);
...
execute procedure audit.energiatodistus_tila_audit();