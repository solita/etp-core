...
create table energiatodistus (
 ...
 lt$lammitys$lammitysmuoto_1_id integer references lammitysmuoto (id),
 lt$lammitys$lammitysmuoto_2_id integer references lammitysmuoto (id),
 lt$lammitys$lammonjako_id integer references lammonjako (id),
