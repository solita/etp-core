...
(2018, 'lt$ilmanvaihto$paaiv$tulo', 47),
(2018, 'lt$ilmanvaihto$erillispoistot$poisto', 48),
(2018, 'lt$ilmanvaihto$erillispoistot$tulo', 49),
(2018, 'lt$ilmanvaihto$ivjarjestelma$poisto', 50),
(2018, 'lt$ilmanvaihto$ivjarjestelma$tulo', 51),
...
(2018, 'lt$lammitys$lammin_kayttovesi$jaon_hyotysuhde', 60),
(2018, 'lt$lammitys$lammin_kayttovesi$tuoton_hyotysuhde', 61),
(2018, 'lt$lammitys$tilat_ja_iv$apulaitteet', 62),
(2018, 'lt$lammitys$tilat_ja_iv$jaon_hyotysuhde', 63),
(2018, 'lt$lammitys$tilat_ja_iv$tuoton_hyotysuhde', 64),
