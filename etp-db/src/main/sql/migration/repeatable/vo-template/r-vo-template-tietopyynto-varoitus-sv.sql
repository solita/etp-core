...
<p>ARA har sänt er en begäran och uppmaning om inlämning av bakgrundsmaterial till detta energicertifikat. ARA utfärdar en varning och kräver att ni lämnar in bakgrundsmaterialet inom en månad från datumet för denna varning. <b>ARA kommer att kontrollera certifikatets riktighet på basis av detta material.</b> Skicka följande bakgrundsmaterial som använts vid upprättandet av certifikatet till ARA:s energicertifikatsregister senast {{määräpäivä}}</p>
