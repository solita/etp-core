...
<p class="oikeellisuus-kohde">
    ...
    Datum för begäran om inlämning: {{#tietopyynto}} {{tietopyynto-pvm}} {{/tietopyynto}}
    {{/energiatodistus}}
</p>
...
<p>ARA har sänt er en begäran om inlämning av bakgrundsmaterial till detta energicertifikat. ARA ber er lämna in bakgrundsmaterialet inom en månad från datumet för denna uppmaning. <b>ARA kommer att kontrollera certifikatets riktighet på basis av detta material.</b> Vi ber er skicka följande bakgrundsmaterial som använts vid upprättandet av certifikatet till ARA:s energicertifikatsregister senast {{määräpäivä}}:</>
