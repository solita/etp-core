...
(2018, 'lt$lammitys$lammin_kayttovesi$jaon_hyotysuhde', 62),

(2018, 'lt$lkvn_kaytto$ominaiskulutus', 63),
(2018, 'lt$lkvn_kaytto$lammitysenergian_nettotarve', 64),

(2018, 'h$ymparys$teksti_fi', 65),
(2018, 'h$ymparys$teksti_sv', 66)
